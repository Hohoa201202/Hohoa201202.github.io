const tool = (() => {
    const products = [
        ...
        {
            img: 'url(https://cdn.mobilecity.vn/mobilecity-vn/images/2018/05/w300/bo-phat-wifi-di-dong-kasda-1.jpg)',
            name: 'Bộ phát Wifi di động 4G Kasda KW9550',
            price: '1.350.000 đ',
            link: '#',
        },
        {
            img: 'url(https://cdn.mobilecity.vn/mobilecity-vn/images/2017/05/w300/Hand_Spinner_Black.jpg)',
            name: 'Hand Fidget Spinner',
            price: '55.000 đ',
            link: '#',
        },
        {
            img: 'url(https://cdn.mobilecity.vn/mobilecity-vn/images/2018/05/w300/thiet-bi-mo-rong-song-kasda-kw5585-1.png)',
            name: 'Thiết bị mởi rộng sóng Kasda KW5585 N300',
            price: '280.000 đ',
            link: '#',
        },
        {
            img: 'url(https://cdn.mobilecity.vn/mobilecity-vn/images/2019/07/w300/tai-nghe-bluetooth-smart-headset.jpg)',
            name: 'Tai nghe Bluetooth Smart Headset',
            price: '699.000 đ',
            link: '#',
        },
